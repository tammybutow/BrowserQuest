    ...
    var App = Class.extend({
        ...
        initAchievementList: function(achievements) {
            ...
            _.each(achievements, function(achievement) {
                ...
                $a.find('.twitter').attr('href', 'http://twitter.com/share?url=http%3A%2F%2Fchaosquest.mozilla.org&text=I%20unlocked%20the%20%27'+ achievement.name +'%27%20achievement%20on%20Mozilla%27s%20%23ChaosQuest%21&related=glecollinet:Creators%20of%20ChaosQuest%2Cwhatthefranck');
                $a.show();
